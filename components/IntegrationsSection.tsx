...
export default function IntegrationsSection() {
  const integrations = [
    ...
    },
    {
      name: "Brevo",
      description:
        "Ensure fast, reliable delivery of transactional emails at scale.",
      color: "green",
      logo: "/logos/br.png",
    },
    {
      ...
      <div className="integrations-container">
        ...
        <div className="integrations-header">
          <h2 className="integrations-title">
            Built to Work With{" "}
            <span className="integrations-highlight">Your Business</span>
          </h2>

          <p className="integrations-subtitle">
            VendorVille integrates with the tools your business already relies
            on, so you can focus on serving customers, not managing logistics.
          </p>
        </div>
        ...
        <div className="integrations-footer">
          <p>
            ...
            <a href="#contact" className="integrations-link">
