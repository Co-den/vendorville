...
import { Check, Star, MapPin, Send } from "lucide-react";
    ...
    <>
      ...
      <div className="discover-hero">
        <button
          ...
          disabled={isLocating}
        >
          <div className="discover-location-icon">
            <Send />
          </div>

          <div className="discover-location-content">
            <div className="discover-location-label">
              <span></span>
              {isLocating ? "Locating..." : "Near you"}
            </div>

            <div className="discover-location-name">
              {locationFilterActive && userLocation ? userLocation : "Near Me"}
            </div>

            <div className="discover-location-hint">Tap for precise GPS</div>
          </div>

          <svg
            className="discover-location-chevron"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
        ...
        <div className="wrap discover-hero-content">
          <span className="discover-eyebrow">Vendors</span>
          <h1>Discovery.</h1>
          <p>
      ...
      <footer>
        <div className="wrap">
          ...
          <div className="footer-bottom">
            <span>© 2026 Vendo rVille Nigeria. All rights reserved.</span>
