...
export default function DashboardOverview() {
  ...
  return (
    <>
      ...
      {businesses.length > 1 && (
        <div className="field-group" style={{ maxWidth: 320, marginBottom: 20 }}>
          <label className="field-label">Viewing stats for</label>
          <select value={activeBusinessId ?? ''} onChange={(e) => setActiveBusinessId(Number(e.target.value))}>
          ...
          <div className="stat-grid">
            <div className="stat-card">
              <div className="stat-card-top">
                <div className="stat-icon"><StatIcon name="trend" /></div>
              </div>
            ...
            <div className="stat-card">
              <div className="stat-card-top">
                <div className="stat-icon"><StatIcon name="cart" /></div>
              </div>
            ...
            <div className="stat-card">
              <div className="stat-card-top">
                <div className="stat-icon"><StatIcon name="box" /></div>
              </div>
            ...
            <div className="stat-card">
              <div className="stat-card-top">
                <div className="stat-icon"><StatIcon name="alert" /></div>
              </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            <div className="panel">
              <div className="panel-head">
                <h2>Recent Orders</h2>
                <a href="/dashboard/orders" className="panel-link">View all</a>
              </div>
              {recentOrders.length === 0 ? (
                <p style={{ fontSize: '0.86rem', color: 'var(--gray)', textAlign: 'center', padding: '24px 0' }}>
                  No orders yet.
                </p>
              ) : (
            ...
            <div className="panel">
              <div className="panel-head">
                ...
                <a href="/dashboard/inventory" className="panel-link">Manage inventory</a>
              </div>
