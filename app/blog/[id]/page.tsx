...
const mockBlogPosts = [
  {
    ...
    excerpt:
      "Learn proven strategies that 200+ Nigerian vendors use to scale their businesses.",
    author: "Chioma Adeyemi",
    authorRole: "Business Coach",
    authorBio:
      "Chioma is a business transformation coach with 15+ years of experience helping Nigerian entrepreneurs scale from side hustle to 7-figure operations.",
    date: "July 3, 2026",
    category: "Growth",
    image:
  ...
  },
  {
    ...
    authorBio:
      "Tunde has helped 500+ Nigerian vendors use data to improve their bottom line.",
    date: "July 1, 2026",
    category: "Tools & Tips",
    image:
    ...
    readTime: "6 min read",
    content:
      "Analytics are the backbone of modern vendor operations. This guide walks you through VendorVille's powerful analytics features and how to use them to grow your business.",
  },
  {
    id: 3,
    ...
    authorBio:
      "Zainab leads customer success at VendorVille and has worked with hundreds of vendors.",
    date: "June 28, 2026",
  ...
  },
  {
    ...
    authorBio:
      "Kunle specializes in pricing strategy and has helped vendors increase margins by 30%.",
    date: "June 25, 2026",
    category: "Pricing",
    image:
    ...
    readTime: "5 min read",
    content:
      "Pricing is one of the most critical decisions vendors make. Learn the framework for pricing that balances competitiveness with profitability.",
  },
  {
    id: 5,
    ...
    authorBio:
      "Ada has managed operations for multi-million naira vendor businesses.",
    date: "June 22, 2026",
    category: "Operations",
    image:
      "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop",
    readTime: "9 min read",
    content:
      "Seasonal patterns significantly impact vendor businesses. Learn how to prepare, plan, and profit during peak demand seasons.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    authorBio:
      "Olu has helped hundreds of Nigerian vendors transition to formal accounting.",
    date: "June 13, 2026",
    category: "Finance",
    image:
      "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop",
    readTime: "7 min read",
    content:
      "Proper financial management is the foundation of sustainable vendor growth.",
  },
];
        ...
        <div className="article-container">
            ...
            <div className="article-body">
              {post.content.split("\n\n").map((paragraph, idx) => {
                ...
                if (paragraph.startsWith("") && paragraph.endsWith("")) {
                  return (
                    <p key={idx} className="bold-intro">
                      {paragraph.replace(/\*\*/g, "")}
                    </p>
                  );
                }
          ...
          <aside className="article-sidebar">
            ...
            <div className="sidebar-card cta-card">
              ...
              <p>
                Have a vendor success story? Write a guest post and inspire
                other Nigerian entrepreneurs.
              </p>
              <Link className="cta-btn" href="share-story">
                Contribute a Post
              </Link>
            </div>
          </aside>
